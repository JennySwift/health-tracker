...
function autocompleteMenu ($typing) {
	...
	$menu = DB::select("select * from (select id, name, 'food' as type from foods where name LIKE '$typing' and user_id = 1 UNION select id, name, 'recipe' as type from recipes where name LIKE '$typing' and user_id = 1) as table1 order by table1.name asc");
